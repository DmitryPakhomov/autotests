...
from autotests.pages.pages_details import LoansDocument


class LoansDocumentsPageCommonActions(LoansCommonPageBlocks):
    def __init__(self, driver: WebDriver, cfg: Configs):
        super().__init__(driver, cfg)
        self.loans_loan_draft_locators = LoansDocument.Locators
